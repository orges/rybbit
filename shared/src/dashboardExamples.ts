import type { DashboardCardMapping, DashboardVizType } from "./dashboards";

/**
 * The vetted example queries the card editor offers.
 *
 * This is shared rather than page-local because the copilot composes dashboards
 * out of it: a proposed card is one a person could have made by clicking an entry
 * in the editor's gallery, so the model never writes SQL and nothing it proposes
 * can fail to parse.
 */
